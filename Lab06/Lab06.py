...
train_gen = datagen_classification.flow(X_train, y_train, batch_size=32)
val_gen = datagen_classification.flow(X_val, y_val, batch_size=32)

plot_loss_accuracy = PlotLossAccuracy()

# Train the model using the separate training and validation generators
